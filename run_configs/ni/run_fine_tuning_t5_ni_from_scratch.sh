...
#SBATCH -p nlp
#SBATCH -A nlp
#SBATCH -w nlp-ada-1,nlp-ada-2,nlp-l40-1,nlp-l40-2,nlp-a40-1
...
# All GPUs: bruno1,bruno2,dym-lab,dym-lab2,galileo1,galileo2,newton3,newton4,newton5,nlp-a40-1,nlp-ada-1,nlp-ada-2,nlp-l40-1,nlp-l40-2,tdk-bm4
...
checkpoint.checkpoint_path=checkpoints/pre_train/from_scratch/hf_t5/c4_en/lr_0_0001_inverse_sqrt_bsz_200_shuffle_p_0_5/2024-03-18_21-25/checkpoint-2000 \
mode=ft \
